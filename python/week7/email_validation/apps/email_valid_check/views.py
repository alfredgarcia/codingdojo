...
def index(request):
    ...
    return render (request, 'email_valid_check/index.html')
...
def success(request):
    ...
    return render (request, 'email_valid_check/success.html', {'emails': emails, 'your_email': request.session.get('email')})
